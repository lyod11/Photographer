...
public class NetUtils {
    ...
    public static AuthToken getToken(String requestedUrl, String code){
        ...
        URL url = createUrl(getPostTokenUrl(code));
        String jsonResponse = null;
        /*
       ...
       // String params = NetUtils.getEncodedParamTokenQuery(code);
        try {
            ...
            jsonResponse = makeHttpPostRequest(url); // POST
        } catch (IOException e) {
            Log.e(LOG_TAG, "Problem making http request", e);
        }
    ...
    //пост реквест
    private static String makeHttpPostRequest(URL url) throws IOException {
        String jsonResponse = "";
...
//    }
    ...
    public static String getPostTokenUrl(String code) {
        return UNSPLASH_URL + "oauth/token"
                + "?client_id=" + APPLICATION_ID
